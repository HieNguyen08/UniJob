...
Nếu làn sóng thứ nhất là \textit{catalog điện tử} (Amazon, eBay), thứ hai là
\textit{mobile commerce}, thứ ba là \textit{social commerce} thì làn sóng thứ tư được
định nghĩa bởi bốn trụ cột: \textbf{AI personalization, nền kinh tế chia sẻ
(sharing/gig economy), Digital Trust \& Reputation, và Hyper-local \& Real-time commerce}.
...
\hline
\rowcolor{emeraldhead} \th{Yếu tố} & \th{Điểm} & \th{Logic} \\
\hline
...
\subsection*{Liên hệ làn sóng thứ tư}
...
\hline
\rowcolor{emeraldhead} \th{Tính năng} & \th{Trụ cột 4th Wave} & \th{Trạng thái} \\
\hline
