  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-10">
      <div className="mx-auto max-w-6xl rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-sm md:p-8">
        <h1 className="text-4xl font-bold text-slate-900">Xác nhận đã làm xong</h1>

        <section className="mt-6 rounded-2xl border border-[var(--color-border)] p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h2 className="text-3xl font-bold text-slate-800">Hỗ trợ nhập liệu Excel luận văn</h2>
              <p className="mt-1 text-base text-slate-500">Mã công việc: #JOB2026-1024</p>
            </div>
          ...
          <div className="mt-3 grid gap-3 text-center md:grid-cols-4">
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-slate-700">Đã nhận việc</p>
            ...
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-slate-700">Sinh viên báo hoàn thành</p>
            ...
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-orange-600">Người đăng xác nhận</p>
            ...
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-slate-500">Thanh toán & Đánh giá</p>
              <p className="text-xs text-slate-400">Chờ xử lý</p>
            </div>
          </div>

          <div className="mt-6 rounded-xl bg-slate-50 p-4">
            <p className="text-lg font-semibold text-slate-700">Kết quả công việc từ sinh viên</p>
            <div className="mt-3 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-500">Em đã hoàn thành file dữ liệu, anh kiểm tra giúp em nhé.</p>
              </div>
            </div>
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-2 rounded-xl border border-[var(--color-border)] bg-white p-3">
              <div>
                <p className="font-semibold text-slate-700">Ket_qua_final.xlsx</p>
          ...
          <div className="mt-5 rounded-xl border border-amber-300 bg-amber-50 p-4">
            <div className="flex items-center gap-2 text-amber-700">
              ...
              <h3 className="text-lg font-semibold">Xác nhận nghiệm thu công việc</h3>
            </div>
            ...
            <div className="mt-3 flex flex-wrap gap-3">
              <button className="flex-1 rounded-xl bg-green-500 px-4 py-2.5 text-base font-semibold text-white hover:bg-green-600">
                Xác nhận: Đã nhận kết quả
              </button>
              <button className="rounded-xl border border-red-400 px-4 py-2.5 text-base font-semibold text-red-500 hover:bg-red-50">
                Báo cáo sự cố
              </button>
            </div>
          ...
          <section className="mt-6 border-t border-[var(--color-border)] pt-4 text-sm text-slate-500">
            <p>
            ...
            <div className="mt-4 grid gap-3 text-center md:grid-cols-3">
              <div>
                <p>Thù lao</p>
                <p className="font-semibold text-slate-700">500,000 VND</p>
              </div>
              <div>
                <p>Thời hạn</p>
                <p className="font-semibold text-slate-700">20/02/2026</p>
              </div>
              <div>
                <p>Sinh viên</p>
                <p className="font-semibold text-slate-700">Nguyễn Văn An</p>
              </div>
            </div>
          </section>
        </section>
